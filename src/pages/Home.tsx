        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
              <a
                href="https://wa.me/1234567890?text=Hello%20LeoneChat"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-8 py-4 bg-[#00A36C] hover:bg-[#00A36C]/90 text-white rounded-xl transition-all shadow-[0_0_30px_rgba(0,163,108,0.3)] hover:shadow-[0_0_40px_rgba(0,163,108,0.5)] group"
              >
                <MessageSquare className="size-5" />
                <span>Chat with LeoneChat Now</span>
              </a>
            ...
            <p className="text-sm text-gray-500">
              💬 Send "Hello" to start chatting with LeoneChat
            </p>
          </div>
